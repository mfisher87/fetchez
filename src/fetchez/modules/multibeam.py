...
# Helper Functions
# =============================================================================
def _parse_mbsystem_inf_bounds(inf_text: StringIO) -> Optional[Tuple[float, float, float, float]]:
...
class MBDB(core.FetchModule):
    ...
    def __init__(self, where: str = '1=1', layer: int = 1, want_inf: bool = True, **kwargs):
